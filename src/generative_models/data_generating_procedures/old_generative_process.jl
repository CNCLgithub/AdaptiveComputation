...
# data generating procedure model function
# ---
# parameters:
# state - Vector{Dot} representing the state of the dots
# t - current timestep
# num_dots - number of dots
# params - (inertia, spring constant, acceleration noise,
# 						position st. dev., velocity st. dev., measurement_noise)
# ---
# returns:
# new state
