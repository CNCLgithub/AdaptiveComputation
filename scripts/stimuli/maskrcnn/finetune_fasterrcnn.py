...
class MOTDataset(object):
    ...
    def __getitem__(self, idx):
        ...
        mask_path = os.path.join(self.root, "DotMasks", self.masks[idx])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-path', default='data/EvalDots', help='dataset')
    parser.add_argument('--output-dir', default='checkpoints/', help='where to save')
